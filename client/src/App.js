...
function App() {
  ...
  const { videoRef, remoteVideoRef, endCall, handleLogin, socket, loginFormElements } = useConnections({userId, setRemoteSocketId, setUserId, setSharedInterests, setInterests});
